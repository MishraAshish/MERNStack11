...
webpackConfig = {
    ...
    //once bundling is done files copied 
    output : {
        path: DIST_DIR + "/app",
...
//1. its a server - so we'll server configurations - http/s, start page... etc
//2. build - transpilation =>  converting our code in es6+ and react format to es5

//a browser does't support arrow function
//()=>{}

//es5 - function
//function normal() {}

//use some middlewares (babel packages) and configure with weback to convert this code to normal 
//function in optimized way

//3.by using middleware - uglifyjson or anyother packge to do  job of minifaction - is to reduce 
//the size of files by removing commented code, extra elements, spaces etc
//let e = require("express"), prt = process.env.PORT || 9000,app = express(), defaultRouter = 

//4. bundling of js files with other static files like - html, css, images ...etc
//and resolving dependency issues - //bundle.js  